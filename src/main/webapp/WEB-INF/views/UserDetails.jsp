...
<div class="dropdown">
  ...
  <div class="container" style="display: flex;">
    ...
    <!-- Main Content Section -->
	    <div class="main-content" style="width: 80%; padding: 20px; background-color: #f9f9f9; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
	    ...
	    <div class="user-details" style="margin-top: 20px;">
	        <p><strong>Name:</strong> ${regModel.name}</p>
	        <p><strong>Email:</strong> ${regModel.email}</p>
	        <p><strong>Address:</strong> ${regModel.address}</p>
	        <p><strong>College Name:</strong> ${regModel.collagename}</p>
	        <p><strong>Mobile No:</strong> ${regModel.mobileno}</p>
	        <p><strong>Course Name:</strong> ${regModel.coursename}</p>
	        <p><strong>Year:</strong> ${regModel.yearno}</p>
	        <p><strong>Gender:</strong> ${regModel.gender}</p>
	        <p><strong>Date Of Birth:</strong> ${regModel.dob}</p>
	        <p><strong>State:</strong> ${regModel.state}</p>
	        <p><strong>City:</strong> ${regModel.city}</p>
	         <p><strong>Pincode:</strong> ${regModel.pincode}</p> 
	    </div>
	</div>
