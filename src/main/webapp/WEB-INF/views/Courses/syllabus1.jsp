...
<h2 class="m-0 text-primary">
    ...
    <div class="course-container">
        ...
        <div class="course-description">
            <h4>Java Course Overview</h4>
            <p>
                This course comprises 43 audio-video spoken tutorials, using which you can self-learn the Java programming language with ease.
            </p>
            <p>
                <strong>STEP 1:</strong> First of all, install Java Eclipse IDE by following the...
            </p>
        </div>
    </div>
