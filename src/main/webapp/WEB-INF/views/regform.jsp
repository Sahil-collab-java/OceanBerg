...
<h2 class="m-0 text-primary">
    ...
    <!--<i class="fa fa-book me-3"></i>-->Oceanberg Technologies
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="/loginpage" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Sign-In<i class="fa fa-arrow-right ms-3"></i></a>
...
<!--         <form action="/reg" method="post"> -->
  ...
  <div class="card-body p-md-5 text-black">
    ...
    <div class="row">
      <div class="col-md-6 mb-4">
        <div class="form-outline">
          <input type="text" id="name" name="name" class="form-control form-control-lg" placeholder="Enter your first name" required />
          <label class="form-label" for="name">First name</label>
        </div>
      </div>
      <div class="col-md-6 mb-4">
        <div class="form-outline">
          <input type="text" id="lastName" name="lastName" class="form-control form-control-lg" placeholder="Enter your last name" required />
    ...
    <div class="form-outline mb-4">
      <input type="text" id="mobileno" name="mobileno" class="form-control form-control-lg" placeholder="Enter your mobile number" required />
      <label class="form-label" for="mobileno">Mobile Number</label>
    </div>

  <div class="form-outline mb-4">
  <input type="email" id="email" name="email" class="form-control form-control-lg" placeholder="Enter your email" required onkeyup="checkEmail()" />
  <label class="form-label" for="email">Email ID</label>
  <div id="emailFeedback" style="color: red;"></div> <!-- Feedback for email -->
</div>

<div class="form-outline mb-4">
  <!-- Username Input -->
  <input type="text" id="username" name="username" class="form-control form-control-lg" placeholder="Enter your username" required onkeyup="checkUsername()" />
  <label class="form-label" for="username">Username</label>
  <div id="usernameFeedback" style="color: red;"></div> <!-- Feedback for username -->
</div>

    <div class="form-outline mb-4">
  <input type="password" id="password" name="password" class="form-control form-control-lg" placeholder="Enter your password" onkeyup="checkPassword()" required />
  <label class="form-label" for="password">Password</label>
  <div id="strengthFeedback" class="strength" style="font-size: 14px;"></div>
</div>
 ...
 <!-- Feedback container -->
    ...
    <div class="form-outline mb-4">
      <input type="text" id="collagename" name="collagename" class="form-control form-control-lg" placeholder="Enter your college name" required />
      <label class="form-label" for="collagename">College Name</label>
    </div>

    <div class="form-outline mb-4">
      <input type="date" id="dob" name="dob" class="form-control form-control-lg" placeholder="Select your date of birth" required />
      <label class="form-label" for="dob">DOB</label>
    </div>

    <div class="form-outline mb-4">
      <input type="text" id="pincode" name="pincode" class="form-control form-control-lg" placeholder="Enter your pincode" required />
      <label class="form-label" for="pincode">Pincode</label>
    </div>

    <div class="form-outline mb-4">
      <input type="text" id="coursename" name="coursename" class="form-control form-control-lg" placeholder="Enter your course name" required />
    ...
    <button type="button" class="btn btn-warning btn-sm ms-2" onclick="saveFormData(event)">Submit form</button>
</div>
...
function saveFormData(event) {
    ...
    const formData = {
        serid: document.getElementById("serid").value.trim(),
        ...
        state: document.getElementById("username").value,
        city: document.getElementById("password").value,
    ...
    fetch('/registration', {
        ...
        .then(data => {
            if (data.successMessage) {
                ...
                if (data.emailError) alert(data.emailError);
                if (data.mobileError) alert(data.mobileError);
            }
        })
        .catch(error => {
